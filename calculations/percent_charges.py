...
def process_percent_of_charges(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
    ...
    rate_key = f"{prov_id}#{rate_sheet_code}#pct_chgs"
...
def process_pct_of_chrg_flat_amt(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
    ...
    calc_bean = term_bundle.calc_bean
    base_pct_of_charge = term_bundle.base_pct_of_charge
    flat_amt = term_bundle.base_rate1
    ranges = term_bundle.service_mod_pos_list
...
def process_percent_of_charges_max(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_percent_of_charges_max_01(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_pct_chg_pd_max(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_pct_chg_pd_max_01(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_pct_chg_per_proc_max(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_pct_chg_per_unit_threshold(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_percent_threshold(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
