...
def process_limit(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:

    service_mod_pos_list = term_bundle.service_mod_pos_list or []
    if not service_mod_pos_list:
        return

    rate_key = f"{provider_bundle.provid}#{provider_bundle.rate_sheet_code}"
...
def process_limit_allowed(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_limit_allowed_percent(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
...
def process_limit_allowed_same_dos(context: Context, provider_bundle: ProviderBundle, term_bundle: TermBundle) -> None:
